...
#nullable enable
public class BoardManagerSolo7 : BoardManagerSolo
{
    protected override void GenerateAllTiles()
    {
        ...
        GenerateBoardTilesInArea(-4, 1, -2, 1, TileName.NormalBoardTile, boardTilesParent);
        GenerateBoardTilesInArea(-3, 2, 1, 2, TileName.NormalBoardTile, boardTilesParent);
        ...
        GenerateBoardTile(-4, -2, TileName.LockedBoardTile, _boardParent, PieceName.Eye);
